...
// The keys are i18n keys — the picker translates them, in both banks.
...
const GROUPS = {
  'cat.home': ['broom', 'washing-machine', 'bed', 'shower', 'bathtub', 'toilet', 'toilet-paper',
  ...
  'cat.body': ['barbell', 'person-simple-run', 'person-simple-bike', 'person-simple-walk',
    'brain', 'eye', 'hair-dryer', 'yin-yang'],
  'cat.health': ['bandaids', 'first-aid-kit', 'heartbeat', 'pill', 'syringe', 'tooth', 'face-mask',
    'cigarette-slash', 'flask', 'test-tube'],
  'cat.food': ['drop', 'coffee', 'apple-logo', 'carrot', 'bread', 'egg', 'cheese', 'cherries',
    'hamburger', 'pizza', 'ice-cream', 'bowl-food', 'bowl-steam', 'onigiri', 'orange-slice',
    'cooking-pot', 'chef-hat', 'fork-knife', 'jar-label'],
  'cat.party': ['confetti', 'balloon', 'cake', 'champagne', 'gift', 'cheers', 'martini', 'brandy',
    'wine', 'beer-stein', 'beer-bottle', 'disco-ball'],
  'cat.work': ['briefcase', 'books', 'pencil', 'note', 'note-pencil', 'push-pin', 'calendar-dots',
    ...
    'gavel', 'factory'],
  'cat.tech': ['laptop', 'desktop', 'desktop-tower', 'code', 'password', 'hard-drives',
    'floppy-disk-back', 'file', 'folder-simple', 'folders', 'download', 'video', 'head-circuit'],
  'cat.leisure': ['palette', 'guitar', 'music-note', 'music-notes', 'microphone-stage', 'headphones',
  ...
  'cat.travel': ['airplane-tilt', 'bicycle', 'bus', 'car-profile', 'van', 'sailboat', 'suitcase',
    'gas-pump', 'engine', 'tire', 'car-battery', 'bridge'],
  'cat.clothes': ['t-shirt', 'pants', 'dress', 'sock', 'sneaker', 'boot', 'high-heel',
    'coat-hanger', 'eyeglasses', 'watch'],
  'cat.animals': ['dog', 'cat', 'rabbit', 'bird', 'cow', 'butterfly', 'paw-print', 'bone', 'feather'],
  'cat.nature': ['plant', 'leaf', 'sun', 'moon', 'rainbow', 'mountains', 'tent', 'umbrella'],
  'cat.misc': ['star', 'sparkle', 'fire', 'lightning', 'heart', 'check-circle', 'check-fat',
...
writeFileSync(
  ...
  `// Generated by scripts/build-icons.mjs — do not edit by hand.\n` +
    `// ${total} duotone Phosphor icons: [background, detail] concatenated.\n` +
    `export const PHOSPHOR_GROUPS: [string, [string, string][]][] = ${JSON.stringify(
      Object.entries(out),
    )}\n\n` +
    `// From an old single-tone character to the duotone pair — migrated at load time.\n` +
