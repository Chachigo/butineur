...
`https://github.com/Chachigo/butineur` → **Ajouter**. Seulement les versions
stables ; activer **Inclure les pré-versions** pour avoir aussi les bêtas.
...
- Depuis la 1.0.0, chaque APK est signé avec la **clé de release** du projet,
  dont l'empreinte SHA-1 est `AB:C3:E5:2C:C7:C9:65:F9:CB:90:42:AB:B7:67:D3:0F:E4:F3:B1:0D`. Android refuse une mise à jour signée d'une
  autre clé, donc celle-ci ne changera pas. Les bêtas jusqu'à la 0.6.0-beta
